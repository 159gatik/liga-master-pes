    ...
    return (
        <main className="min-h-screen bg-[#0a0a0a] text-[#f0ece0] font-sans p-6 md:p-10">
            ...
            <section className="max-w-6xl mx-auto relative bg-[#111111] border border-[#2a2a2a] border-t-4 border-t-[#c9a84c] p-10 md:p-16 mb-10 overflow-hidden">
                {/* Marca de agua decorativa detrás */}
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <Link href="/reglamento" className="border-2 border-[#c9a84c] text-[#c9a84c] font-barlow-condensed font-bold tracking-[3px] uppercase py-2.5 px-7 hover:bg-[#c9a84c] hover:text-[#0a0a0a] transition-all">
                            Ver Reglamento
                        </Link>
                    </div>
                </div>
